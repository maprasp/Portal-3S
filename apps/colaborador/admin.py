...
#J    readonly_fields =  [ "first_name", "last_name", "email", "data_nascimento", "telefone", "cpf", "documento_tipo", "documento", "vinculo", "predio", "divisao", "ramal", "responsavel", "data_inicio", "data_fim", "registro_inpe", "empresa", "externo", "username", "uid", "is_superuser", "is_staff", "is_active", "last_login", "data_inicio", "data_fim", "date_joined"]
    readonly_fields =  [ "first_name", "last_name", "email", "vinculo", "predio", "divisao", "ramal", "responsavel", "data_inicio", "data_fim", "registro_inpe", "empresa", "externo", "username", "uid", "is_superuser", "is_staff", "is_active", "last_login", "data_inicio", "data_fim", "date_joined"]
...
#J            self.readonly_fields =  [ "first_name", "last_name", "email", "data_nascimento", "nacionalidade","telefone", "cpf", "documento_tipo", "documento",  "vinculo", "predio", "divisao", "ramal","responsavel", "data_inicio", "data_fim", "registro_inpe", "empresa", "externo", "username", "uid", "is_superuser", "is_staff", "is_active", "last_login", "date_joined"]
            self.readonly_fields =  [ "first_name", "last_name", "email", "nacionalidade",    "vinculo", "predio", "divisao", "ramal","responsavel", "data_inicio", "data_fim", "registro_inpe", "empresa", "externo", "username", "uid", "is_superuser", "is_staff", "is_active", "last_login", "date_joined"]
            self.inlines = []
...
#J                self.readonly_fields = [ "first_name", "last_name",  "data_nascimento", "username", "uid", "is_staff", "registro_inpe", "is_active", "last_login", "date_joined", "vinculo", "predio", "divisao", "responsavel", "registro_inpe", "empresa", "data_inicio", "data_fim", "vinculo", "is_superuser"]
                self.readonly_fields = [ "first_name", "last_name",  "username", "uid", "is_staff", "registro_inpe", "is_active", "last_login", "date_joined", "vinculo", "predio", "divisao", "responsavel", "registro_inpe", "empresa", "data_inicio", "data_fim", "vinculo", "is_superuser"]
...
#J            "Administrador":["cpf", "data_nascimento", "registro_inpe", "empresa", "data_fim", "responsavel", ],
            "Administrador":["registro_inpe", "empresa", "data_fim", "responsavel", ],
